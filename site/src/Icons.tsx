...
export function Shuffle({ className }: P) {
  return (
    <svg {...base} className={className}>
...
/** npm mark (filled). */
export function Npm({ className }: P) {
  return (
    <svg viewBox="0 0 24 24" className={className} aria-hidden fill="currentColor">
      <path d="M1.763 0C.786 0 0 .786 0 1.763v20.474C0 23.214.786 24 1.763 24h20.474c.977 0 1.763-.786 1.763-1.763V1.763C24 .786 23.214 0 22.237 0H1.763zm2.913 4.946h14.648v14.648h-3.662V8.608h-3.662v10.986H4.676V4.946z" />
    </svg>
  );
}
